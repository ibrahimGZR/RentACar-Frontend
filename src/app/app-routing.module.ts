...
const routes: Routes = [
  ...
  {
    path: 'rentals/list/delete/:carId',
  ...
  {
    path: 'carimages/list',
    component: CarImageListComponent,
    canActivate: [LoginGuard],
  },
  {
    path: 'carimages/list/add/:carId',
  ...
  { path: 'cars/brand/:brandId/color/:colorId', component: CarComponent },
  {
    ...
    canActivate: [LoginGuard, CartGuardGuard],
  },
  ...
  {
    path: 'colors/list/add',
    component: ColorAddComponent,
    canActivate: [LoginGuard],
  },
  {
    path: 'colors/list/update/:colorId',
    component: ColorUpdateComponent,
    canActivate: [LoginGuard],
  },
  {
    path: 'colors/list/delete/:colorId',
  ...
  {
    path: 'brands/list/add',
    component: BrandAddComponent,
    canActivate: [LoginGuard],
  },
  {
    path: 'brands/list/update/:brandId',
    component: BrandUpdateComponent,
    canActivate: [LoginGuard],
  },
  {
    path: 'brands/list/delete/:brandId',
  ...
  {
    path: 'cars/list/update/:carId',
    component: CarUpdateComponent,
    canActivate: [LoginGuard],
  },
  {
    path: 'cars/list/delete/:carId',
