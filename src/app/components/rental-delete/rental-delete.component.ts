...
export class RentalDeleteComponent implements OnInit {
  ...
  getRentalbyCarId(){
    this.rentalService.getRentalsDetails().subscribe(response => {
      this.rentals = response.data.filter(r=>r.carDto.carId==this.activatedRoute.snapshot.params["carId"])
  ...
  delete(){
    ...
    rentalForDelete.id=this.rentals.find(r=>r.carDto.carId==this.activatedRoute.snapshot.params["carId"]).id
    rentalForDelete.carId=parseInt(this.activatedRoute.snapshot.params["carId"])
    rentalForDelete.customerId=parseInt(this.localStorageService.get("customerId"))
    rentalForDelete.customerId=this.rentals.find(r=>r.carDto.carId==this.activatedRoute.snapshot.params["carId"]).customerDto.customerId
    rentalForDelete.rentDate=this.rentals.find(r=>r.carDto.carId==this.activatedRoute.snapshot.params["carId"]).rentDate
    rentalForDelete.returnDate=this.rentals.find(r=>r.carDto.carId==this.activatedRoute.snapshot.params["carId"]).returnDate
